  ...
  return (
    ...
    <section id='about' className='max-w-4xl w-full flex flex-col items-center mx-auto mt-16'>
        ...
        <div className='px-6 py-3 w-full max-w-4xl border-2 border-red-400 rounded-md flex justify-center items-center flex-col my-6'>
            ...
            <p className='text-red-300 text-center text-base'>ohuewohfewihfo feowji foiew fpwej fpewijf epwjfwpoj fpjfpeowiajf poewj fpow jfopjwe pofj wepfoj weofj pfeji eoiwg oih pgih oihgqwe pihg woe hpg eogiph ogihpewg ewogi phogipqwhle goighwe oghwopioioewjpg oijgp rieojg eoiqjg oriejg [jproeq giroejg rejgp[reo eijgporejg oerqgj [pj o</p>
        </div>
